        ...
        <div class="sidebar">
            <div class="snb">
                <ul>
                    ...
                    <li><a id="qrybtn" style="cursor: pointer;">문의하기</a></li>
                </ul>
            </div>
        </div>
        <div class="col-detail">
            <div class="c_check_warp">
                ...
                <div class="c_box email_inquiry">
                    ...
                    <br><br><a id="qrywbtn" class="button" style="cursor: pointer;">문의하기</a>
                </div>
                <div class="c_box my_advice">	
                    <strong class="c_tit"><span class="emoji-center"></span><br>내 상담 내역 확인</strong><br><br>
                    <span class="c_txt">이메일 문의 조회입니다.</span><br><br>
                    <a id="qrybtn" class="button" style="cursor: pointer;">문의내역 조회</a>
                </div>
            </div><br>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", "#qrybtn", function() {
        ...
        $(document).on("click", "#qrywbtn", function() {
            var sessionUid = '${sessionScope.uid}';
            if(!sessionUid || sessionUid.trim() === '') {
                if (confirm("로그인 후 이용 가능합니다.\n로그인 페이지로 이동하시겠습니까?")) {
                    window.location.href = "/login?redirect=/inquirywrite";
                    return;
                } else {
                    return;
                }
            } else {
                window.location.href = "/inquirywrite";
            }
        })
    });
</script>
