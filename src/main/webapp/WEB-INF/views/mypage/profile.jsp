		...
		<div class="profile-section">
			...
			<div class="profile-info">
				...
				<div>
					...
					<a href="javascript:void(0)" id="editNicknameBtn">✏️</a>
				</div>
				<div>
					아이디 :
					<%=customer.getUid()%>
		...
		<div class="container">
			...
			<div class="main-content">
				<div>
					...
					<!-- 오류 메시지 표시 영역 -->
					<c:if test="${not empty errorMessage}">
						<div style="color: red; margin-bottom: 10px; padding: 10px; background-color: rgba(255, 0, 0, 0.1); border-radius: 5px;">
							${errorMessage}
						</div>
					</c:if>
					<div>
							...
							<table class="profile-input">
								...
								<tr>
									<td colspan=2 style='text-align: center'><input
										...
										<button id="probtn" type="button" onClick="location.href='/myhome'">취소</button>
									</td>
								</tr>
							</table>
						</form>
...
<script>
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		console.log('편집 버튼:', editBtn);
		console.log('닫기 버튼:', closeBtn);
		console.log('저장 버튼:', saveNicknameBtn);
	});
